...
class TestData(Dataset):
    def __init__(self, testpath, device="cuda", iscrop=True, crop_size=224, scale=1.25, face_detector='mtcnn'):
        '''
        ...
        if isinstance(testpath, list):
            ...
            self.imagepath_list = glob(os.path.join(testpath, '*.jpg')) +  glob(os.path.join(testpath, '*.png')) + glob(os.path.join(testpath, '*.bmp'))
